...
public class AdminDashboardView extends JPanel {
    ...
    public AdminDashboardView() {
        ...
        setBackground(new Color(245, 245, 245)); // Abu-abu terang biar elegan
    ...
    // --- Fungsi Bantuan Buat Bikin Desain Kartu ---
    ...
    // Fungsi buat ganti warna pas diklik
